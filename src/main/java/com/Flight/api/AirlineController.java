...
public class AirlineController {
    ...
    @GetMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public ResultData<AirlineResponseDto> get(@PathVariable("id") int id){
        Airline airline = this.airlineService.get(id);
        return ResultHelper.success(this.modelMapper.forResponse().map(airline, AirlineResponseDto.class));
    }
    //taih aralığı
